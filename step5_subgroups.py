...
pdf = pd.read_pickle('/home/claude/data/point_level.pkl')
games = pd.read_pickle('/home/claude/data/games_parsed.pkl')[['game_id', 'margin']]
...
m4 = sm.load('/home/claude/data/m4.pickle')
base = m4.params['lag1']
