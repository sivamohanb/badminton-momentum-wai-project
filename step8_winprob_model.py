...
for name, model in models.items():
    ...
    fig.savefig(f'/home/claude/data/wp_cm_{safe}.png', dpi=170)
    plt.close(fig)
...
fig_roc.savefig('/home/claude/data/wp_roc_all_models.png', dpi=170)
plt.close(fig_roc)

import json
with open('/home/claude/data/wp_model_results.json', 'w') as f:
    json.dump(results, f, indent=2)
with open('/home/claude/data/wp_base_rate.txt', 'w') as f:
